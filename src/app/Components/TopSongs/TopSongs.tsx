...
import { currentTrackIndexState, musicTracksState, playbackStatusState } from '@/app/helpers/State';
                ...
                {loading ? (
                    ...
                    songsDisplay.map((song, index) => (
                        <SongItem
                            ...
                            song={song}
                            index={index}
                            isPlaying={currentTrackIndex === index && playbackStatus === PlaybackStatus.PLAYING}
